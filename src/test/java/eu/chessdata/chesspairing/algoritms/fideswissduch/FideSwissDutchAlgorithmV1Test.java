...
public class FideSwissDutchAlgorithmV1Test extends FideSwissDutchAlgorithmV1 {
	...
	/**
	 * This is the first bug detected on the mobile application. The algorithm
	 * is fixed now
	 * 
	 * @throws UnsupportedEncodingException
	 */
	...
	/**
	 * This test is disabled until wee table the bug. If you would like to see
	 * what the bug is about then enable the @Test and read the error
	 * 
	 * @throws UnsupportedEncodingException
	 */
	//@Test
